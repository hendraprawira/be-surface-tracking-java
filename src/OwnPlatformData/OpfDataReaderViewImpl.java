...
public class OpfDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements OpfDataReaderView
{
    ...
    public OpfDataReaderViewImpl(OpfTypeSupport ts)
    {
        typeSupport = ts;
