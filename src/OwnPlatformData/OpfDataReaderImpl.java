...
public class OpfDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements OpfDataReader
{
    private static final long serialVersionUID = 1L;

    private final long copyCache;
    private final OpfTypeSupport typeSupport;

    public OpfDataReaderImpl(OpfTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new OpfDataReaderViewImpl(typeSupport);
    }
}
